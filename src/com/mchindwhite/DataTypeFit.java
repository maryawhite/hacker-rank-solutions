...
public class DataTypeFit {
    ...
    public static void main(String[] args) {
        ...
        int t = sc.nextInt();   //the user will enter a number t which denotes the number of test cases

        for(int i = 0; i < t; i++) {

            try {
                long x = sc.nextLong();     //and the user will enter another number x which is the integer we are testing
